%--------------------------------------------------------------------------
% Script file for reading consecutive STR_VC2_1b products.
%--------------------------------------------------------------------------
% 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% DESCRIPTION: The routine reads all STR_VC2_1b products in current directory.
%
% INPUTS: One or more GOCE *STR_VC2_1b*.EEF files
%
% OUTPUTS: - Time GPS
...
%               of Read_STR_VC2_1b_dir.m routine.
%
% NOTES ON USAGE: launch in a MATLAB shell the Read_STR_VC2_1b_dir.m
%                 routine.


d=dir('*STR_VC2*_1b*.EEF');
