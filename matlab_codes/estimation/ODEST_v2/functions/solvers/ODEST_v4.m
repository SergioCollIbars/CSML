function [Cnm_new, Snm_new, state, XNOT_c, XNOT_p, Pc_new, Pp_new, PHI_t] = ODEST_v4(t ,Y, rn, vn,...
    ...
    for j = 1:Nt
        ...
        % look for null space n = 2
        Hc = [hc(4, 20); hc(7:9, 20)];
        B = null(Hc');
        
        dY = B' * [Y(4, j) - Yc(4); Y(7:9, j)- Yc(7:9)]; 
