...
% at different orbit altitudes. (error budget). Compute Quartile Percentage
% (QP)
...
for h = 1:NH
    ...
    % Disturbance 3
    [M_D3_XX, Q3_XX] = compute_med_Q3(D3_XX);
    mu_h_xx(h, 2) = M_D3_XX;
    sigma_h_xx(h, 2) = Q3_XX;

    [M_D3_ZZ, Q3_ZZ] = compute_med_Q3(D3_ZZ);
    mu_h_zz(h, 2) = M_D3_ZZ;
    sigma_h_zz(h, 2) = Q3_ZZ;

    [M_D3_YY, Q3_YY] = compute_med_Q3(D3_YY);
    mu_h_yy(h, 2) = M_D3_YY;
    sigma_h_yy(h, 2) = Q3_YY;
end
