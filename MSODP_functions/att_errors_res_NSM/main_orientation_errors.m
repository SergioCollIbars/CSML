...
figure()
semilogy(t_dateTime, vecnorm(att_Err), 'LineWidth', 2); grid on;
title("Attitude error magnitude"); ylabel('[rad]');
...
figure()
plot(t_dateTime, noise_mask./1E-15, 'LineStyle','none', 'Marker','.', 'Color', 'k');
hold on;
plot(t_dateTime, dY_NSM./1E-15, 'LineStyle','none', 'Marker','.');
grid on; ylabel('micro - Eotvos');
title('GG residuals with NSM + noise');
